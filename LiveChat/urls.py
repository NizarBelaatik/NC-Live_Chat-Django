...
from LiveChat_app.views import HOME ,open_chat_area,load_conv_area,load_add_conv,load_Profile_search,create_chat,load_details_area,upload_files_from_chat
...
urlpatterns = [
    ...
    path('load-Profile-search/',load_Profile_search, name='load-Profile-search'),
